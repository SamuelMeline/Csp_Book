 ...
 */
final class Version20230728092048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE build DROP description, DROP image');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE build ADD description LONGTEXT NOT NULL, ADD image VARCHAR(255) NOT NULL');
    }
}
